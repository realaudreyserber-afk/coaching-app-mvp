...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === 'destructive'
        ? 'border-red-500/50 bg-red-50 text-red-900 dark:bg-red-950/40 dark:text-red-100'
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn('absolute right-1 top-1 rounded-md p-1 opacity-70 hover:opacity-100', className)}
    toast-close=""
    {...props}
  >
    <X className="h-4 w-4" />
